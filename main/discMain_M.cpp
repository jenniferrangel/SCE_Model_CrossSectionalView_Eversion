...
int main(int argc, char* argv[]) {
	...
	double mitoRndActomyoStrengthScaling = 7.0; //Please consult SceNodes.cu to see what are the scaling applied to non-dividing cells and disc_NXX_X.cfg file to see what is the corresponding default spring constant. //Kevin
